...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Session3}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers ,\, Sequences ,\, TLC}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} TupleMax {\p@lbrace}}%
 \@x{\@s{12.29} {\p@variables} inp \.{=} {\langle} 1 ,\, 3 ,\, 2 {\rangle}
 ,\,\@s{4.1} max \.{=} \.{-} 99999 ,\, i \.{=} 1 {\p@semicolon}}%
\@x{\@s{12.29} {\p@lbrace}}%
 \@x{\@s{20.5} {\p@assert}\@s{4.1} \A\, n \.{\in} 1 \.{\dotdot} Len ( inp )
 \.{:} inp [ n ] \.{>} \.{-} 99999 {\p@semicolon}}%
 \@x{\@s{20.5} {\p@while} {\p@lparen} i \.{\leq} Len ( inp ) {\p@rparen}
 {\p@lbrace}}%
 \@x{\@s{28.7} {\p@if} {\p@lparen} inp [ i ] \.{>} max {\p@rparen} {\p@lbrace}
 max \.{:=} inp [ i ] {\p@rbrace} {\p@semicolon}}%
\@x{\@s{28.7} i \.{:=} i \.{+} 1}%
\@x{\@s{20.5} {\p@rbrace} {\p@semicolon}}%
 \@x{\@s{20.5} {\p@assert}\@s{12.29} ( \E\, n \.{\in} 1 \.{\dotdot} Len ( inp
 ) \.{:} max \.{=} inp [ n ] )}%
 \@x{\@s{49.2} \.{\land}\@s{5.46} ( \A\, n \.{\in} 1 \.{\dotdot} Len ( inp )
 \.{:} max \.{\geq} inp [ n ] )}%
\@x{\@s{12.29} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{d2f21b4f}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{faaa532a}'')
}%
\@xx{}%
\@x{ {\VARIABLES} inp ,\, max ,\, i ,\, pc}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} inp ,\, max ,\, i ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
 \@x{\@s{37.72} \.{\land} inp\@s{4.70} \.{=} {\langle} 1 ,\, 3 ,\, 2
 {\rangle}}%
\@x{\@s{37.72} \.{\land} max \.{=} \.{-} 99999}%
\@x{\@s{37.72} \.{\land} i \.{=} 1}%
\@x{\@s{37.72} \.{\land} pc \.{=}\@w{Lbl\_1}}%
\@pvspace{8.0pt}%
\@x{ Lbl\_1 \.{\defeq} \.{\land} pc \.{=}\@w{Lbl\_1}}%
 \@x{\@s{42.84} \.{\land} Assert ( \A\, n \.{\in} 1 \.{\dotdot} Len ( inp )
 \.{:} inp [ n ] \.{>} \.{-} 99999 ,\,}%
\@x{\@s{86.75}\@w{Failure\ of\ assertion\ at\ line\ 9,\ column\ 6.} )}%
\@x{\@s{42.84} \.{\land} pc \.{'} \.{=}\@w{Lbl\_2}}%
\@x{\@s{42.84} \.{\land} {\UNCHANGED} {\langle} inp ,\, max ,\, i {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Lbl\_2 \.{\defeq} \.{\land} pc \.{=}\@w{Lbl\_2}}%
\@x{\@s{42.84} \.{\land} {\IF} i \.{\leq} Len ( inp )}%
\@x{\@s{66.11} \.{\THEN} \.{\land} {\IF} inp [ i ] \.{>} max}%
\@x{\@s{120.69} \.{\THEN} \.{\land} max \.{'} \.{=} inp [ i ]}%
\@x{\@s{120.69} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{152.00} \.{\land} max \.{'} \.{=} max}%
\@x{\@s{97.42} \.{\land} i \.{'} \.{=} i \.{+} 1}%
\@x{\@s{97.42} \.{\land} pc \.{'} \.{=}\@w{Lbl\_2}}%
 \@x{\@s{66.11} \.{\ELSE} \.{\land} Assert (\@s{8.2} ( \E\, n\@s{3.12} \.{\in}
 1 \.{\dotdot} Len ( inp ) \.{:} max \.{=} inp [ n ] )}%
 \@x{\@s{141.33} \.{\land} ( \A\, n \.{\in} 1 \.{\dotdot} Len ( inp ) \.{:}
 max \.{\geq} inp [ n ] ) ,\,}%
\@x{\@s{141.33}\@w{Failure\ of\ assertion\ at\ line\ 14,\ column\ 6.} )}%
\@x{\@s{97.42} \.{\land} pc \.{'} \.{=}\@w{Done}}%
\@x{\@s{97.42} \.{\land} {\UNCHANGED} {\langle} max ,\, i {\rangle}}%
\@x{\@s{42.84} \.{\land} inp \.{'} \.{=} inp}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} Lbl\_1 \.{\lor} Lbl\_2}%
\@x{\@s{52.13} \.{\lor}\@s{0.54} Terminating}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 10 23:19:39 \ensuremath{CET} 2024 by \ensuremath{alexander
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Dec} 26
 11:48:57 \ensuremath{PST} 2020 by \ensuremath{claus
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Dec} 25
 00:00:00 \ensuremath{PST} 2020 by \ensuremath{claus
}%
\end{cpar}%
\end{lcom}%
\end{document}
